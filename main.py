...
class gnssSimulator(QOpenGLWidget):
    ...
    def draw_circle_on_earth(self, orbit_params, satellite_position, receiver_position):
        ...
        radius = 50 + np.linalg.norm(np.array(closest_point) - np.array(receiver_position))
    ...
    def new_satellite_form(self):
        ...
        semi_major_axis_input.setRange(6380, 1000000) 
    ...
    def edit_receiver_form(self):
        ...
        latitude_input.setSingleStep(0.01)
        ...
        longitude_input.setSingleStep(0.01)
